...
available_setting = {
    ...
    "model": "",  # 可选择: gpt-4o, gpt-4o-mini, gpt-4-turbo, claude-3-sonnet, wenxin, moonshot, qwen-turbo, xunfei, glm-4, minimax, gemini等模型，全部可选模型详见common/const.py文件
    ...
    "feishu_app_id": "cli_a9aa0118f3385bc2",  # 飞书机器人应用APP Id
    "feishu_app_secret": "MfTeObtxGiw5uchMseJRQcPK2GER7MbB",  # 飞书机器人APP secret
    "feishu_token": "oPZvPAUHkgI0nxGr1kKg6gXkY7YvLupk",  # 飞书 verification token
    "feishu_bot_name": "demobot",  # 飞书机器人的名字
    # 钉钉配置
